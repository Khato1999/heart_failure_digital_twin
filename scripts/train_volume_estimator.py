...
from heart_twin.echonet_integration import VOLUME_FEATURE_NAMES, video_features  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--dataset-dir", type=Path, default=ROOT / "EchoNet-Dynamic")
    parser.add_argument("--output", type=Path, default=ROOT / "outputs" / "echonet_volume_estimator.joblib")
